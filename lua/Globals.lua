...
kDeathMessageIcon = enum( { 'None', 
							...
							'Revolver', 'Metabolize', 'Crush', 'BabblerAbility', 'VoidShield', 'Snipe', 'Katana',
                            } )
...
kMinimapBlipType = enum( { 'Undefined', 'TechPoint', 'ResourcePoint', 'Scan', 'EtherealGate', 'HighlightWorld',
                           ...
                           'BlueprintPowerPoint', 'ARC', 'Drifter', 'MAC', 'Infestation', 'InfestationDying', 'MoveOrder', 'AttackOrder', 'BuildOrder', 'SensorBlip', 
