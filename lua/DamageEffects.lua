...
kDamageEffects =
{
    ...
    damage_sound =
    {
        damageSounds =
        {
			...
			{sound = "sound/combat.fev/combat/materials/metal/knife/knife", surface = "metal", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/organic/knife/knife", surface = "organic", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/organic/knife/knife", surface = "infestation", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/rock/knife/knife", surface = "rock", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/thin_metal/knife/knife", surface = "thin_metal", doer = "Knife", world_space = true, done = true},
            //{sound = "sound/combat.fev/combat/materials/electronic/knife", surface = "electronic", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/armor/knife/knife", surface = "armor", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/flesh/knife/knife", surface = "flesh", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/membrane/knife/knife", surface = "membrane", doer = "Knife", world_space = true, done = true},
            {sound = "sound/combat.fev/combat/materials/organic/knife/knife", doer = "Knife", world_space = true, done = true},
			...
			{sound = "sound/NS2.fev/materials/metal/axe", surface = "metal", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/organic/axe", surface = "organic", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/organic/axe", surface = "infestation", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/rock/axe", surface = "rock", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/thin_metal/axe", surface = "thin_metal", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/electronic/axe", surface = "electronic", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/armor/axe", surface = "armor", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/flesh/axe", surface = "flesh", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/membrane/axe", surface = "membrane", doer = "Katana", world_space = true, done = true},
            {sound = "sound/NS2.fev/materials/organic/axe", doer = "Katana", world_space = true, done = true},
    ...
    damage_decal =
    {
        damageDecals = 
        {
			...
			{decal = "cinematics/vfx_materials/decals/clawmark_01.material", scale = 0.4, doer = "Katana", done = true},
    ...
    damage =
    {
        ...
        damageEffects =
        {
			...
			{player_cinematic = "cinematics/materials/%s/axe.cinematic", doer = "Katana", done = true},
