...
function BuildTechData()
    ...
    local techData = {
		...
		{ [kTechDataId] = kTechId.Medic,      [kTechDataDisplayName] = "MEDIC", [kTechDataMapName] = Medic.kMapName, [kTechDataModel] = MarineVariantMixin.kModelNames["female"]["green"], [kTechDataMaxExtents] = Vector(Player.kXZExtents, Player.kYExtents, Player.kXZExtents), [kTechDataMaxHealth] = Medic.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataPointValue] = kMarinePointValue},
		{ [kTechDataId] = kTechId.Assault,      [kTechDataDisplayName] = "ASSAULT", [kTechDataMapName] = Assault.kMapName, [kTechDataModel] = MarineVariantMixin.kModelNames["male"]["black"], [kTechDataMaxExtents] = Vector(Player.kXZExtents, Player.kYExtents, Player.kXZExtents), [kTechDataMaxHealth] = Assault.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataPointValue] = kMarinePointValue},
		{ [kTechDataId] = kTechId.Scout,      [kTechDataDisplayName] = "SCOUT", [kTechDataMapName] = Scout.kMapName, [kTechDataModel] = MarineVariantMixin.kModelNames["male"]["green"], [kTechDataMaxExtents] = Vector(Player.kXZExtents, Player.kYExtents, Player.kXZExtents), [kTechDataMaxHealth] = Scout.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataPointValue] = kMarinePointValue},
		{ [kTechDataId] = kTechId.Engineer,      [kTechDataDisplayName] = "ENGINEER", [kTechDataMapName] = Engineer.kMapName, [kTechDataModel] = MarineVariantMixin.kModelNames["male"]["green"], [kTechDataMaxExtents] = Vector(Player.kXZExtents, Player.kYExtents, Player.kXZExtents), [kTechDataMaxHealth] = Engineer.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataPointValue] = kMarinePointValue},
...
--        { [kTechDataId] = kTechId.SentryBattery, [kTechDataBuildRequiresMethod] = GetRoomHasNoSentryBattery, [kTechDataBuildMethodFailedMessage] = "COMMANDERERROR_ONLY_ONE_BATTERY_PER_ROOM",  [kTechDataHint] = "SENTRY_BATTERY_HINT", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataMapName] = SentryBattery.kMapName,                [kTechDataDisplayName] = "SENTRY_BATTERY",          [kTechDataCostKey] = kSentryBatteryCost,      [kTechDataPointValue] = kSentryBatteryPointValue, [kTechDataModel] = SentryBattery.kModelName,  [kTechDataEngagementDistance] = 2,   [kTechDataBuildTime] = kSentryBatteryBuildTime, [kTechDataMaxHealth] = kSentryBatteryHealth,  [kTechDataMaxArmor] = kSentryBatteryArmor, [kTechDataTooltipInfo] = "SENTRY_BATTERY_TOOLTIP", [kTechDataHotkey] = Move.S, [kTechDataNotOnInfestation] = kPreventMarineStructuresOnInfestation, [kVisualRange] = SentryBattery.kRange, [kTechDataObstacleRadius] = 0.25},
		...
		{ [kTechDataId] = kTechId.LightMachineGun,      [kTechDataMaxHealth] = kMarineWeaponHealth, [kTechDataTooltipInfo] = "LMG_TOOLTIP",    [kTechDataMapName] = LightMachineGun.kMapName,                    [kTechDataDisplayName] = "LMG",         [kTechDataModel] = LightMachineGun.kModelName, [kTechDataDamageType] = kRifleDamageType, [kTechDataCostKey] = kRifleCost, },
		...
		{ [kTechDataId] = kTechId.Revolver,     [kTechDataMaxHealth] = kMarineWeaponHealth,       [kTechDataMapName] = Revolver.kMapName,                   [kTechDataDisplayName] = "REVOLVER",         [kTechDataModel] = Revolver.kModelName, [kTechDataDamageType] = kRevolverDamageType, [kTechDataCostKey] = kRevolverCost, [kTechDataTooltipInfo] = "REVOLVER_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Cannon,      [kTechDataMaxHealth] = kMarineWeaponHealth, [kTechDataTooltipInfo] = "HEAVY_RIFLE_TOOLTIP", [kTechDataPointValue] = kWeaponPointValue,    [kTechDataMapName] = Cannon.kMapName,     [kTechDataDisplayName] = "Cannon",         [kTechDataModel] = Cannon.kModelName, [kTechDataDamageType] = kHeavyRifleDamageType, [kTechDataCostKey] = kHeavyRifleCost, },
		...
		{ [kTechDataId] = kTechId.Flag, [kTechDataMapName] = Flag.kMapName,[kTechDataModel] = Flag.kModelName, },
...
*/       
		...
		// Marine Perks
		//{ [kTechDataId] = kTechId.Mechanic,              [kTechDataCostKey] = kMechanicResearchCost,                 [kTechDataResearchTimeKey] = kMechanicResearchTime,     [kTechDataDisplayName] = "MECHANIC_PERK", [kTechDataTooltipInfo] = "MARINE_MECHANIC_TOOLTIP"},
		...
		{ [kTechDataId] = kTechId.Snipe,        [kTechDataDisplayName] = "SNIPE", [kTechDataDamageType] = kSpikeDamageType, [kTechDataTooltipInfo] = "SPIKES_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.SporeMineAbility,      [kTechDataMapName] = DropSporeMinesAbility.kMapName,            [kTechDataDisplayName] = "BUILD_ABILITY", [kTechDataTooltipInfo] = "BUILD_ABILITY_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.VoidShield,     [kTechDataMapName] = VoidShield.kMapName,  [kTechDataCategory] = kTechId.Fade,   [kTechDataCostKey] = kMetabolizeHealthResearchCost, [kTechDataResearchTimeKey] = kMetabolizeHealthResearchTime,      [kTechDataDisplayName] = "VOIDSHIELD",  [kTechDataTooltipInfo] = "VOIDSHIELD_TOOLTIP"}, 		
        { [kTechDataId] = kTechId.BabblerBombAbility,       [kTechDataCategory] = kTechId.Gorge,  [kTechDataMapName] = BabblerBombAbility.kMapName,        [kTechDataDamageType] = kBileBombDamageType,  [kTechDataDisplayName] = "BABBLERBOMB", [kTechDataCostKey] = kBileBombResearchCost, [kTechDataResearchTimeKey] = kBileBombResearchTime, [kTechDataTooltipInfo] = "BABBLERBOMB_TOOLTIP" },
		...
		{ [kTechDataId] = kTechId.Devour,         [kTechDataCategory] = kTechId.Onos,  [kTechDataMapName] = Devour.kMapName, [kTechDataCostKey] = 0, [kTechDataResearchTimeKey] = 0,      [kTechDataDisplayName] = "DEVOUR",  [kTechDataTooltipInfo] = "DEVOUR_TOOLTIP"},  
        ...
        { [kTechDataId] = kTechId.AcidRocket ,        [kTechDataCategory] = kTechId.Fade,   [kTechDataMapName] = AcidRocket.kMapName,   [kTechDataDisplayName] = "ACIDROCKET", [kTechDataCostKey] = kVortexResearchCost, [kTechDataResearchTimeKey] = kVortexResearchTime, [kTechDataTooltipInfo] = "VORTEX_TOOLTIP"},
...
*/  
        // Alien buildables
        { [kTechDataId] = kTechId.Egg,    [kTechDataHint] = "EGG_HINT",    [kTechDataMapName] = Egg.kMapName,                         [kTechDataDisplayName] = "EGG",         [kTechDataTooltipInfo] = "EGG_DROP_TOOLTIP", [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataModel] = Egg.kModelName, [kTechDataPointValue] = kEggPointValue, [kTechDataBuildTime] = 1, [kTechDataMaxExtents] = Vector(1.75/2, .664/2, 1.275/2), [kTechDataRequiresInfestation] = false }, 
        { [kTechDataId] = kTechId.GorgeEgg,   [kTechDataHint] = "EGG_HINT", [kTechDataMapName] = GorgeEgg.kMapName,                         [kTechDataDisplayName] = "GORGE_EGG",         [kTechDataTooltipInfo] = "GORGE_EGG_DROP_TOOLTIP", [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataModel] = Egg.kModelName, [kTechDataPointValue] = kEggPointValue, [kTechDataResearchTimeKey] = kEggGestateTime, [kTechDataCostKey] = kGorgeEggCost, [kTechDataMaxExtents] = Vector(1.75/2, .664/2, 1.275/2), [kTechDataRequiresInfestation] = false }, 
        ...
        { [kTechDataId] = kTechId.FadeEgg,    [kTechDataHint] = "EGG_HINT", [kTechDataMapName] = FadeEgg.kMapName,                         [kTechDataDisplayName] = "FADE_EGG",         [kTechDataTooltipInfo] = "FADE_EGG_DROP_TOOLTIP", [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataModel] = Egg.kModelName, [kTechDataPointValue] = kEggPointValue, [kTechDataResearchTimeKey] = kEggGestateTime, [kTechDataCostKey] = kFadeEggCost, [kTechDataMaxExtents] = Vector(1.75/2, .664/2, 1.275/2), [kTechDataRequiresInfestation] = false }, 
        { [kTechDataId] = kTechId.OnosEgg,    [kTechDataHint] = "EGG_HINT", [kTechDataMapName] = OnosEgg.kMapName,                         [kTechDataDisplayName] = "ONOS_EGG",         [kTechDataTooltipInfo] = "ONOS_EGG_DROP_TOOLTIP", [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataModel] = Egg.kModelName, [kTechDataPointValue] = kEggPointValue, [kTechDataResearchTimeKey] = kEggGestateTime, [kTechDataCostKey] = kOnosEggCost, [kTechDataMaxExtents] = Vector(1.75/2, .664/2, 1.275/2), [kTechDataRequiresInfestation] = false }, 

        //{ [kTechDataId] = kTechId.Harvester, [kTechDataIgnorePathingMesh] = true, [kTechDataBioMass] = kHarvesterBiomass, [kTechDataSpawnBlock] = true, [kTechDataMaxExtents] = Vector(1, 1, 1), [kTechDataHint] = "HARVESTER_HINT", [kTechDataCollideWithWorldOnly] = true, [kTechDataAllowStacking] = true, [kTechDataGhostModelClass] = "AlienGhostModel",    [kTechDataMapName] = Harvester.kMapName,                    [kTechDataDisplayName] = "HARVESTER",  [kTechDataRequiresInfestation] = false,   [kTechDataCostKey] = kHarvesterCost,            [kTechDataBuildTime] = kHarvesterBuildTime, [kTechDataHotkey] = Move.H, [kTechDataMaxHealth] = kHarvesterHealth, [kTechDataMaxArmor] = kHarvesterArmor, [kTechDataModel] = Harvester.kModelName,           [kStructureAttachClass] = "ResourcePoint", [kTechDataPointValue] = kHarvesterPointValue, [kTechDataTooltipInfo] = "HARVESTER_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Whip, [kTechDataBioMass] = kWhipBiomass, [kTechDataSupply] = kWhipSupply, [kTechDataHint] = "WHIP_HINT", [kTechDataGhostModelClass] = "AlienGhostModel",    [kTechDataMapName] = Whip.kMapName,                         [kTechDataDisplayName] = "WHIP",  [kTechDataCostKey] = kWhipCost,    [kTechDataRequiresInfestation] = false, [kTechDataHotkey] = Move.W,        [kTechDataBuildTime] = kWhipBuildTime, [kTechDataModel] = Whip.kModelName,           [kTechDataMaxHealth] = kWhipHealth, [kTechDataMaxArmor] = kWhipArmor,   [kTechDataDamageType] = kDamageType.Structural, [kTechDataInitialEnergy] = kWhipInitialEnergy,      [kTechDataMaxEnergy] = kWhipMaxEnergy, [kVisualRange] = Whip.kRange, [kTechDataPointValue] = kWhipPointValue, [kTechDataTooltipInfo] = "WHIP_TOOLTIP", [kTechDataGrows] = true, [kTechDataAllowConsumeDrop] = true, [kTechDataMaxAmount] = 1},
        ...
        { [kTechDataId] = kTechId.Shift, [kTechDataBioMass] = kShiftBiomass, [kTechDataSupply] = kShiftSupply, [kTechDataHint] = "SHIFT_HINT", [kTechDataGhostModelClass] = "ShiftGhostModel",    [kTechDataMapName] = Shift.kMapName,                        [kTechDataDisplayName] = "SHIFT",  [kTechDataRequiresInfestation] = false, [kTechDataCostKey] = kShiftCost,    [kTechDataHotkey] = Move.S,        [kTechDataBuildTime] = kShiftBuildTime, [kTechDataModel] = Shift.kModelName,           [kTechDataMaxHealth] = kShiftHealth,  [kTechDataMaxArmor] = kShiftArmor,  [kTechDataInitialEnergy] = kShiftInitialEnergy,      [kTechDataMaxEnergy] = kShiftMaxEnergy, [kTechDataPointValue] = kShiftPointValue, [kVisualRange] = kEchoRange, [kTechDataTooltipInfo] = "SHIFT_TOOLTIP", [kTechDataGrows] = true },

        { [kTechDataId] = kTechId.Veil, [kTechDataBioMass] = kVeilBiomass, [kTechDataHint] = "VEIL_HINT", [kTechDataGhostModelClass] = "AlienGhostModel",     [kTechDataMapName] = Veil.kMapName,                         [kTechDataDisplayName] = "VEIL",  [kTechDataCostKey] = kVeilCost,     [kTechDataRequiresInfestation] = false, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kVeilBuildTime, [kTechDataModel] = Veil.kModelName,           [kTechDataMaxHealth] = kVeilHealth, [kTechDataMaxArmor] = kVeilArmor,  [kTechDataPointValue] = kVeilPointValue, [kTechDataTooltipInfo] = "VEIL_TOOLTIP", [kTechDataGrows] = true, [kTechDataObstacleRadius] = 0.5 },
        ...
        { [kTechDataId] = kTechId.Spur, [kTechDataBioMass] = kSpurBiomass,  [kTechDataHint] = "SPUR_HINT", [kTechDataGhostModelClass] = "AlienGhostModel",     [kTechDataMapName] = Spur.kMapName,                         [kTechDataDisplayName] = "SPUR",  [kTechDataCostKey] = kSpurCost,     [kTechDataRequiresInfestation] = false, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kSpurBuildTime, [kTechDataModel] = Spur.kModelName,           [kTechDataMaxHealth] = kSpurHealth, [kTechDataMaxArmor] = kSpurArmor,  [kTechDataPointValue] = kSpurPointValue, [kTechDataTooltipInfo] = "SPUR_TOOLTIP", [kTechDataGrows] = true, [kTechDataObstacleRadius] = 0.75 },
        ...
        { [kTechDataId] = kTechId.Shell, [kTechDataBioMass] = kShellBiomass, [kTechDataHint] = "SHELL_HINT",  [kTechDataGhostModelClass] = "AlienGhostModel",     [kTechDataMapName] = Shell.kMapName,                         [kTechDataDisplayName] = "SHELL",  [kTechDataCostKey] = kShellCost,     [kTechDataRequiresInfestation] = false, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kShellBuildTime, [kTechDataModel] = Shell.kModelName,           [kTechDataMaxHealth] = kShellHealth, [kTechDataMaxArmor] = kShellArmor,  [kTechDataPointValue] = kShellPointValue, [kTechDataTooltipInfo] = "SHELL_TOOLTIP", [kTechDataGrows] = true, [kTechDataObstacleRadius] = 0.75 },
...
/*
        { [kTechDataId] = kTechId.TeleportHydra, [kTechIDShowEnables] = false,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_HYDRA",  [kTechDataCostKey] = kEchoHydraCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Hydra.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportWhip, [kTechIDShowEnables] = false, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_WHIP",  [kTechDataCostKey] = kEchoWhipCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Whip.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportTunnel,  [kTechIDShowEnables] = false,[kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_TUNNEL",  [kTechDataCostKey] = kEchoTunnelCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = TunnelEntrance.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportCrag, [kTechIDShowEnables] = false,[kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_CRAG",  [kTechDataCostKey] = kEchoCragCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Crag.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShade,  [kTechIDShowEnables] = false,[kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHADE",  [kTechDataCostKey] = kEchoShadeCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Shade.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShift, [kTechIDShowEnables] = false,[kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHIFT",  [kTechDataCostKey] = kEchoShiftCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Shift.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportVeil, [kTechIDShowEnables] = false, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_VEIL",  [kTechDataCostKey] = kEchoVeilCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Veil.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportSpur, [kTechIDShowEnables] = false,[kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SPUR",  [kTechDataCostKey] = kEchoSpurCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Spur.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShell,  [kTechIDShowEnables] = false, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHELL",  [kTechDataCostKey] = kEchoShellCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Shell.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
...
*/
        ...
        { [kTechDataId] = kTechId.Babbler,  [kTechDataMapName] = Babbler.kMapName,  [kTechDataDisplayName] = "BABBLER",  [kTechDataModel] = Babbler.kModelName, [kTechDataMaxHealth] = kBabblerHealth, [kTechDataMaxArmor] = kBabblerArmor, [kTechDataPointValue] = kBabblerPointValue, [kTechDataTooltipInfo] = "BABBLER_TOOLTIP", [kTechDataMaxAmount] = kMaxBabblersPerPlayer },
        ...
        { [kTechDataId] = kTechId.SporeMine, [kTechDataHint] = "HYDRA_HINT", [kTechDataTooltipInfo] = "HYDRA_TOOLTIP", [kTechDataAllowConsumeDrop] = true, [kTechDataGhostModelClass] = "AlienGhostModel",    [kTechDataMaxAmount] = kSporeMines,       [kTechDataMapName] = SporeMine.kMapName,                        [kTechDataDisplayName] = "HYDRA",           [kTechDataCostKey] = kHydraCost,       [kTechDataBuildTime] = kHydraBuildTime, [kTechDataMaxHealth] = kHydraHealth, [kTechDataMaxArmor] = kHydraArmor, [kTechDataModel] = Hydra.kModelName, [kVisualRange] = Hydra.kRange, [kTechDataRequiresInfestation] = false, [kTechDataPointValue] = kHydraPointValue, [kTechDataGrows] = true},
        ...
        //{ [kTechDataId] = kTechId.HallucinateWhip, [kTechDataRequiresMature] = true, [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] =      "HALLUCINATE_WHIP",      [kTechDataModel] = Whip.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_WHIP_TOOLTIP", [kTechDataCostKey] = kHallucinateWhipEnergyCost },
        //{ [kTechDataId] = kTechId.HallucinateShade, [kTechDataRequiresMature] = true, [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] =     "HALLUCINATE_SHADE",     [kTechDataModel] = Shade.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_SHADE_TOOLTIP", [kTechDataCostKey] = kHallucinateShadeEnergyCost },
        //{ [kTechDataId] = kTechId.HallucinateCrag, [kTechDataRequiresMature] = true, [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] =      "HALLUCINATE_CRAG",      [kTechDataModel] = Crag.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_CRAG_TOOLTIP", [kTechDataCostKey] = kHallucinateCragEnergyCost },
        //{ [kTechDataId] = kTechId.HallucinateShift, [kTechDataRequiresMature] = true, [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] =     "HALLUCINATE_SHIFT",     [kTechDataModel] = Shift.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_SHIFT_TOOLTIP", [kTechDataCostKey] = kHallucinateShiftEnergyCost },        
        //{ [kTechDataId] = kTechId.HallucinateHarvester, [kTechDataRequiresMature] = true, [kStructureAttachClass] = "ResourcePoint", [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] = "HALLUCINATE_HARVESTER", [kTechDataModel] = Harvester.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_HARVESTER_TOOLTIP", [kTechDataCostKey] = kHallucinateHarvesterEnergyCost },
        //{ [kTechDataId] = kTechId.HallucinateHydra, [kTechDataRequiresMature] = true, [kTechDataEngagementDistance] = 3.5, [kTechDataRequiresInfestation] = false, [kTechDataDisplayName] =     "HALLUCINATE_HYDRA",     [kTechDataModel] = Hydra.kModelName, [kTechDataTooltipInfo] = "HALLUCINATE_HYDRA_TOOLTIP", [kTechDataCostKey] = kHallucinateHydraEnergyCost },
		...
		{ [kTechDataId] = kTechId.kCommandStationNeedsRepairs,         [kTechDataAlertSound] = MarineCommander.kCommandStationNeedsRepairs,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
		{ [kTechDataId] = kTechId.kCommandStationHealed,         [kTechDataAlertSound] = MarineCommander.kCommandStationHealed,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true},
		{ [kTechDataId] = kTechId.kCommandStation75,         [kTechDataAlertSound] = MarineCommander.kCommandStation75,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
		{ [kTechDataId] = kTechId.kCommandStation50,         [kTechDataAlertSound] = MarineCommander.kCommandStation50,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
		{ [kTechDataId] = kTechId.kCommandStation25,         [kTechDataAlertSound] = MarineCommander.kCommandStation25,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
		{ [kTechDataId] = kTechId.kCommandStation10,         [kTechDataAlertSound] = MarineCommander.kCommandStation10,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
		{ [kTechDataId] = kTechId.kCommandStation5,         [kTechDataAlertSound] = MarineCommander.kCommandStation5,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.CommandStationUnderAttack},
//        { [kTechDataId] = kTechId.MarineAlertInfantryPortalUnderAttack,         [kTechDataAlertSound] = InfantryPortal.kUnderAttackSound,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 1, [kTechDataAlertText] = "MARINE_ALERT_INFANTRYPORTAL_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.IPUnderAttack},
		...
		{ [kTechDataId] = kTechId.kHiveNeedsRepairs,         [kTechDataAlertSound] = AlienCommander.kHiveNeedsRepairs,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "MARINE_ALERT_COMMANDSTATION_UNDERAT",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		{ [kTechDataId] = kTechId.kHiveHealed,         [kTechDataAlertSound] = AlienCommander.kHiveHealed,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_UNDERATTACK",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true},
		{ [kTechDataId] = kTechId.kHive75,         [kTechDataAlertSound] = AlienCommander.kHive75,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_UNDERATTACK",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		{ [kTechDataId] = kTechId.kHive50,         [kTechDataAlertSound] = AlienCommander.kHive50,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_UNDERATTACK",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		{ [kTechDataId] = kTechId.kHive25,         [kTechDataAlertSound] = AlienCommander.kHive25,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_UNDERATTACK",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		{ [kTechDataId] = kTechId.kHive10,         [kTechDataAlertSound] = AlienCommander.kHive10,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_DYING",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		{ [kTechDataId] = kTechId.kHive5,         [kTechDataAlertSound] = AlienCommander.kHive5,                   [kTechDataAlertType] = kAlertType.Info,   [kTechDataAlertPriority] = 2, [kTechDataAlertText] = "ALIEN_ALERT_HIVE_DYING",  [kTechDataAlertTeam] = true, [kTechDataAlertIgnoreDistance] = true, [kTechDataAlertSendTeamMessage] = kTeamMessageTypes.HiveUnderAttack},
		...
		{ [kTechDataId] = kTechId.WeaponCache, 	[kTechDataHint] = "WEAPON_CACHE_HINT", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataRequiresPower] = true,      [kTechDataMapName] = WeaponCache.kMapName,                   [kTechDataDisplayName] = "WEAPON_CACHE",              [kTechDataCostKey] = kArmoryCost,              [kTechDataBuildTime] = kArmoryBuildTime, [kTechDataMaxHealth] = kWeaponCacheHealth, [kTechDataMaxArmor] = kWeaponCacheArmor, [kTechDataEngagementDistance] = kArmoryEngagementDistance, [kTechDataModel] = WeaponCache.kModelName, [kTechDataPointValue] = kWeaponCachePointValue, [kTechDataInitialEnergy] = kArmoryInitialEnergy,   [kTechDataMaxEnergy] = kArmoryMaxEnergy, [kTechDataNotOnInfestation] = true, [kTechDataTooltipInfo] = "ARMORY_TOOLTIP", [kTechDataAllowConsumeDrop] = true, [kTechDataMaxAmount] = kNumArmoriesPerPlayer },

		{ [kTechDataId] = kTechId.Katana,  	[kTechDataTooltipInfo] = "KATANA_TOOLTIP", [kTechDataMapName] = Katana.kMapName, [kTechDataDisplayName] = "KATANA",         [kTechDataModel] = Knife.kModelName, [kTechDataDamageType] = kKatanaDamageType, [kTechDataCostKey] = kKnifeCost, },
    }
