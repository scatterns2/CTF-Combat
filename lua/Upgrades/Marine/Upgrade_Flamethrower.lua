...
FlamethrowerUpgrade.cost			= { 2 }                          				// cost of the upgrade in points
...
FlamethrowerUpgrade.minPlayerLevel 	= 8												// Controls whether this upgrade requires the recipient to be a minimum level
