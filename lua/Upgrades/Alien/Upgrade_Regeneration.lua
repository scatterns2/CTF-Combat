...
RegenerationUpgrade.kBoostRegenScalarPerLevel = 1.5
RegenerationUpgrade.kBoostRegenPercentPerLevel = 1.5

// Define these statically so we can easily access them without instantiating too.
RegenerationUpgrade.cost 				= { 1, 1, 1 }                             		// cost of the upgrade in points
...
RegenerationUpgrade.triggerInterval		= { 1, 1, 1 } 									// Specify the timer interval (in seconds) per level.
...
RegenerationUpgrade.damageRegenPause 	= 3
