...
Script.Load("lua/Balance_Combat.lua")

// Gamerules info
Script.Load("lua/GamerulesInfo.lua")

// Classes, upgrades etc.
Script.Load("lua/XpMixin.lua")
...
Script.Load("lua/CustomDoor.lua")
...
Script.Load("lua/CombatDeathmatchGamerules.lua")
Script.Load("lua/CombatCaptureGamerules.lua")
Script.Load("lua/CombatCTFGamerules.lua")
Script.Load("lua/InfectionGamerules.lua")
Script.Load("lua/TechPoint.lua")
Script.Load("lua/BaseSpawn.lua")
Script.Load("lua/ReadyRoomSpawn.lua")
Script.Load("lua/CombatSpawn.lua")
Script.Load("lua/Pheromone.lua")
Script.Load("lua/Weapons/ViewModel.lua")

// Extra Entities Stuff
Script.Load("lua/ExtraEntities/TeleportTrigger.lua")
Script.Load("lua/ExtraEntities/FuncTrain.lua")
Script.Load("lua/ExtraEntities/FuncPlatform.lua")
Script.Load("lua/ExtraEntities/FuncTrainWaypoint.lua")
Script.Load("lua/ExtraEntities/FuncMoveable.lua")
Script.Load("lua/ExtraEntities/FuncDoor.lua")
Script.Load("lua/ExtraEntities/PushTrigger.lua")
Script.Load("lua/ExtraEntities/LogicTimer.lua")
Script.Load("lua/ExtraEntities/LogicMultiplier.lua")
Script.Load("lua/ExtraEntities/LogicSwitch.lua")
Script.Load("lua/ExtraEntities/LogicWeldable.lua")
Script.Load("lua/ExtraEntities/LogicFunction.lua")
Script.Load("lua/ExtraEntities/LogicDialogue.lua")
Script.Load("lua/ExtraEntities/LogicCounter.lua")
Script.Load("lua/ExtraEntities/LogicTrigger.lua")
Script.Load("lua/ExtraEntities/LogicLua.lua")
Script.Load("lua/ExtraEntities/LogicEmitter.lua")
Script.Load("lua/ExtraEntities/LogicEmitterDestroyer.lua")
Script.Load("lua/ExtraEntities/LogicListener.lua")
Script.Load("lua/ExtraEntities/LogicButton.lua")
Script.Load("lua/ExtraEntities/LogicWorldTooltip.lua")
Script.Load("lua/ExtraEntities/LogicWaypoint.lua")
Script.Load("lua/ExtraEntities/LogicGiveItem.lua")
Script.Load("lua/ExtraEntities/LogicReset.lua")
Script.Load("lua/ExtraEntities/LogicBreakable.lua")
Script.Load("lua/ExtraEntities/LogicEventListener.lua")
Script.Load("lua/ExtraEntities/LogicCinematic.lua")
Script.Load("lua/ExtraEntities/LogicPowerPointListener.lua")
Script.Load("lua/ExtraEntities/FuncRotateable.lua")
Script.Load("lua/ExtraEntities/MapSettings.lua")
Script.Load("lua/ExtraEntities/MapChange.lua")
Script.Load("lua/ExtraEntities/NobuildArea.lua")
Script.Load("lua/ExtraEntities/GravityTrigger.lua")

// Marine structures
Script.Load("lua/MAC.lua")
Script.Load("lua/Mine.lua")
Script.Load("lua/SporeMine.lua")
Script.Load("lua/LaserMine.lua")
//Script.Load("lua/Extractor.lua")
Script.Load("lua/Armory.lua")
Script.Load("lua/WeaponCache.lua")
...
Script.Load("lua/RailgunSentry.lua")
...
Script.Load("lua/Weapons/Alien/AcidRocketBomb.lua")
...
Script.Load("lua/DevouredPlayer.lua")
...
Script.Load("lua/Medic.lua")
Script.Load("lua/Assault.lua")
Script.Load("lua/Scout.lua")
Script.Load("lua/Engineer.lua")
...
Script.Load("lua/Weapons/Marine/LightMachineGun.lua")
Script.Load("lua/Weapons/Marine/Revolver.lua")
Script.Load("lua/Weapons/Marine/HeavyRifle.lua")
Script.Load("lua/Weapons/Marine/Cannon.lua")
...
Script.Load("lua/Weapons/Marine/Knife.lua")
...
Script.Load("lua/Weapons/Marine/Katana.lua")
...
Script.Load("lua/Flags/Flag.lua")
